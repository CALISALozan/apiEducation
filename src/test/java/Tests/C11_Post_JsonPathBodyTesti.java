...
public class C11_Post_JsonPathBodyTesti {
        ...
        oldugunu test edin
 */
            // 1- endtpoint ve request body hazırla
            ...
            requestBody.put("bookindates", rezervasyonTarihleriJson);
           ...
           response
                   ...
                   .body("booking.firstname", equalTo("Ozan"),
